...
function Header() {
  useEffect(() => {
    ...
    const navToggleEvent = (elem) => {
      if (!navbar || !navCloseBtn || !overlay) return;
    ...
    <header className="header" data-header>
      ...
      <div className="header-top">
        <div className="container">
          <a href="tel:+917471173334" className="helpline-box">
      ...
      <div className="header-bottom">
        <div className="container">
          <ul className="social-list">
            <li>
              <a href="https://api.whatsapp.com/send?phone=7471173334" target='blank' className="social-link">
                <ion-icon name="logo-whatsapp"></ion-icon>
              </a>
            </li>
            <li>
              <a href="https://www.instagram.com/trailmarkadventures?igsh=a3RhbWc5aGZyeHBs" target='blank' className="social-link">
                <ion-icon name="logo-instagram"></ion-icon>
              </a>
            </li>
            <li>
              <a href="mailto:trailmarkadventures@gmail.com" target='blank' className="social-link">
          ...
          <nav className="navbar" data-navbar>
            <div className="navbar-top">
              <a href="#" className="logo">
                <img src={Logo} alt="Trail Adventure logo" />
              </a>
          ...
          <a href="https://api.whatsapp.com/send?phone=7471173334" target='blank' className="btn btn-primary">Book Now</a>
        </div>
      </div>
    </header>
  );
